...
from base_qwen2_5_32b_test import EchoForQwen as EchoForQwen32B
...
def main():
    ...
    elif "mimo" in args.model_name.lower() or "32b" in args.model_name.lower():
        model = EchoForQwen32B(config)
    else:
