...
def main():
    parser = argparse.ArgumentParser(description="Baseline V* Evaluation ONLINE via API (Metadata & Think Mode Support)")
    ...
    parser.add_argument("--output-path", type=str, default="baseline_vstar_online_results.jsonl")
    ...
    # Debug / Output config
    parser.add_argument("--debug-dir", type=str, default="debug_baseline_vstar_online")
    ...
    def process_item(item):
        ...
        if args.think:
            ...
            if "Answer with the option's letter" not in question:
                question += "\n Please answer with the option's letter from the given choices directly./no_think"
...
Do not provide any explanation."""
    ...
    # Summary Report
    print("\n" + "="*50)
    print("BASELINE V* ONLINE EVALUATION REPORT")
    print("="*50)
    total_correct = 0
    total_samples = 0
    total_crops = 0
