...
def main():
    parser = argparse.ArgumentParser(description="Baseline V* Evaluation ONLINE via API (Enhanced Tracking)")
    ...
    parser.add_argument("--output-path", type=str, default="baseline_vstar_online_enhanced_results.jsonl")
    ...
    # Debug / Output config
    parser.add_argument("--debug-dir", type=str, default="debug_baseline_vstar_enhanced")
...
Do not provide any explanation."""
        ...
        print(f"########## Sample {sample_id} | Choice: {choice} | GT: {item['label']} | Correct: {is_correct} | Tokens: {tokens} | Time: {elapsed_time:.2f}s")
    ...
    # Summary Report
    print("\n" + "="*50)
    print("ENHANCED BASELINE V* ONLINE EVALUATION REPORT")
    print("="*50)
    total_correct = 0
    total_samples = 0
    total_crops = 0
