...
def main():
    parser = argparse.ArgumentParser(description="Echo Framework Evaluation on V* Benchmark (Enhanced)")
    ...
    parser.add_argument("--output-path", type=str, default="enhanced_echo_eval_results.jsonl")
    ...
    parser.add_argument("--debug-dir", type=str, default="debug_enhanced_echo_eval")
    ...
    def process_item(item):
        ...
        try:
            ...
            # Calls the updated thread-safe generate mapping returning stats as well
            response_text, tracker_data = model.generate_with_tracking(img, question, custom_debug_dir=local_debug_dir)
            metadata = {}
...
Do not provide any explanation."""
            ...
            print(f"########## Sample {sample_id} | Choice: {choice} | GT: {item['label']} | Correct: {is_correct} | Tokens: {tracker_data['total_tokens']} | Time: {tracker_data['total_wall_time']:.2f}s")
    ...
    print(f"Starting Parallel Enhanced Echo evaluation with {args.num_workers} workers...")
    ...
    # Summary Report
    print("\n" + "=" * 50)
    print("ENHANCED ECHO FRAMEWORK EVALUATION REPORT")
    print("=" * 50)
    total_correct = 0
    total_samples = 0
    total_tokens = 0
