...
def main():
    ...
    parser.add_argument("--no-visual-prompt", action="store_false", dest="visual_prompt",
                        help="Disable visual prompt in final crop")
    ...
    parser.add_argument("--eval-failed", action="store_true",
                        help="Only evaluate cases where the model failed in vstar_vllm_results.jsonl")
    parser.add_argument("--failed-log-path", type=str, default="../vstar_vllm_results.jsonl",
                        help="Path to the previous results file to find failed cases")
    ...
    parser.add_argument("--sample-list", type=str, default=None,
                        help="Path to a txt file containing question_ids to evaluate")

    # Ablation
    parser.add_argument("--select-strategy", type=str, default='normal')
    parser.add_argument("--max-reasoning-step", type=int, default=None)
    ...
    config.max_reasoning_step = args.max_reasoning_step
    config.region_choose_strategy = args.select_strategy
    # ── 保存 Metadata ──────────────────────────────────────────────────────
    metadata = {
